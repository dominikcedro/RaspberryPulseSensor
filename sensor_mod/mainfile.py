...
background_label = tk.Label(window, bg='#FFFFFF')
background_label.place(relwidth=1, relheight=1)

frame = tk.Frame(window, bg='#FF85A1')  # Frame color
frame.pack(expand=True)

welcome_label = tk.Label(frame, text=" Welcome to Raspberry Pulse Sensor Program ", bg='#FF85A1', fg='#FFFFFF', font=('Arial', 22, 'bold'))
welcome_label.grid(row=0, column=0)

instructions_label = tk.Label(frame, text="Instructions:\n1. Insert finger in the pulsometer\n2. Enter your age\n3. Click 'start sensor' button\n4. Wait 15 sec\n5. Click 'show graph' to examine your pulse\n", bg='#FF85A1', fg='#FFFFFF', font=('Arial', 16), anchor='w')
instructions_label.grid(row=1, column=0, padx=20)

age_entry = tk.Entry(frame, font=('Arial', 12), bg='#FF9D5C', fg='black')
age_entry.grid(row=3, column=0)

spacer_label2 = tk.Label(frame, text="", bg='#FF85A1', font=('Arial', 16, 'bold'))
spacer_label2.grid(row=4, column=0)

button = tk.Button(frame, text="Show Graph", command=show_graph, font=('Arial', 16, 'bold'), bg='#FF5C5C', fg='white')
button.grid(row=5, column=0)

spacer_label = tk.Label(frame, text="", bg='#FF85A1', font=('Arial', 16, 'bold'))
spacer_label.grid(row=6, column=0)

pulse_label = tk.Label(frame, text="", bg='#FF9D5C', fg='white', font=('Arial', 16, 'bold'))
pulse_label.grid(row=7, column=0)

start_button = tk.Button(window, text="Start Sensor", command=start_sensor, font=('Arial', 16, 'bold'), bg='#FF5C5C', fg='white', width=20, height=3)
